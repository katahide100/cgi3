...
リア充には関係ないよ。<br>
<br>
<form action="valentine.cgi" name="send" method="post">
...
<tr><td colspan="2" align="center"><input type="submit" value="バレンタインの勲章を受け取る"></td></tr>
</table>
</form>
<br>
