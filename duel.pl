...
print "光/ゼロ： $P2{'lz_win'}勝<br>\n" if($P2{'lz_win'} > 0);
print "水/ゼロ： $P2{'wz_win'}勝<br>\n" if($P2{'wz_win'} > 0);
print "闇/ゼロ： $P2{'dz_win'}勝<br>\n" if($P2{'dz_win'} > 0);
print "火/ゼロ： $P2{'fz_win'}勝<br>\n" if($P2{'fz_win'} > 0);
print "自然/ゼロ： $P2{'nz_win'}勝<br>\n" if($P2{'nz_win'} > 0);
...
print "光/水/ゼロ： $P2{'lwz_win'}勝<br>\n" if($P2{'lwz_win'} > 0);
print "水/闇/ゼロ： $P2{'wdz_win'}勝<br>\n" if($P2{'wdz_win'} > 0);
print "闇/火/ゼロ： $P2{'dfz_win'}勝<br>\n" if($P2{'dfz_win'} > 0);
print "火/自然/ゼロ： $P2{'fnz_win'}勝<br>\n" if($P2{'fnz_win'} > 0);
print "自然/光/ゼロ： $P2{'nlz_win'}勝<br>\n" if($P2{'nlz_win'} > 0);
print "光/闇/ゼロ： $P2{'ldz_win'}勝<br>\n" if($P2{'ldz_win'} > 0);
print "水/火/ゼロ： $P2{'wfz_win'}勝<br>\n" if($P2{'wfz_win'} > 0);
print "闇/自然/ゼロ： $P2{'dnz_win'}勝<br>\n" if($P2{'dnz_win'} > 0);
print "火/光/ゼロ： $P2{'flz_win'}勝<br>\n" if($P2{'flz_win'} > 0);
print "自然/水/ゼロ： $P2{'nwz_win'}勝<br>\n" if($P2{'nwz_win'} > 0);
...
print "闇/火/自然/ゼロ： $P2{'dfnz_win'}勝<br>\n" if($P2{'dfnz_win'} > 0);
print "水/火/自然/ゼロ： $P2{'wfnz_win'}勝<br>\n" if($P2{'wfnz_win'} > 0);
print "水/闇/自然/ゼロ： $P2{'wdnz_win'}勝<br>\n" if($P2{'wdnz_win'} > 0);
print "水/闇/火/ゼロ： $P2{'wdfz_win'}勝<br>\n" if($P2{'wdfz_win'} > 0);
print "光/火/自然/ゼロ： $P2{'lfnz_win'}勝<br>\n" if($P2{'lfnz_win'} > 0);
print "光/闇/自然/ゼロ： $P2{'ldnz_win'}勝<br>\n" if($P2{'ldnz_win'} > 0);
print "光/闇/火/ゼロ： $P2{'ldfz_win'}勝<br>\n" if($P2{'ldfz_win'} > 0);
print "光/水/自然/ゼロ： $P2{'lwnz_win'}勝<br>\n" if($P2{'lwnz_win'} > 0);
print "光/水/火/ゼロ： $P2{'lwfz_win'}勝<br>\n" if($P2{'lwfz_win'} > 0);
print "光/水/闇/ゼロ： $P2{'lwdz_win'}勝<br>\n" if($P2{'lwdz_win'} > 0);
print "水/闇/火/自然/ゼロ： $P2{'nolightz_win'}勝<br>\n" if($P2{'nolightz_win'} > 0);
print "光/闇/火/自然/ゼロ： $P2{'nowaterz_win'}勝<br>\n" if($P2{'nowaterz_win'} > 0);
print "光/水/火/自然/ゼロ： $P2{'nodarkz_win'}勝<br>\n" if($P2{'nodarkz_win'} > 0);
print "光/水/闇/自然/ゼロ： $P2{'nofirez_win'}勝<br>\n" if($P2{'nofirez_win'} > 0);
print "光/水/闇/火/ゼロ： $P2{'nonaturez_win'}勝<br>\n" if($P2{'nonaturez_win'} > 0);
