...
# &com_error("$phasestr[$phase]にはマナゾーン以外にカードを移動することはできません") if $phase == 2 && $parea != 0;
  ...
  if ( $parea == 9 ) {
    ...
    if ( $F{'decktop'} ) {
      ...
      com_error("サイキック・クリーチャー以外のカードを超次元ゾーンに移動することはできません")  unless (syu_chk($cardno, 103) || syu_chk($cardno, 119));
...
sub put_card_sub {
  ...
  $parea == 0 ? "マナゾーン" : "シールド",
  $parea == 0 ? "出した。" : "セット！");
  if (syu_chk($cardno, 103) || syu_chk($cardno, 119))  {
...
sub move_sub {
  my $side = $_[0];
  &p_mess;
  if ((syu_chk($cardno, 103) || syu_chk($cardno, 119)) && ($parea != 9)) {
    s_mes("《$c_name[$cardno]》は超次元ゾーンに送られた。");
  ...
  if ($F{'run_select'}) {
    ...
    if ($S{'p'} eq "shield") {
      ...
      for (my ($i) = 0; $i < scalar @card; $i++) {
        if (&syu_chk($card[$i], 103) || &syu_chk($card[$i], 119)) {
...
#          : $c_name[$cno] eq "竜魔神王バルカディア・NEX" ? (11,41,50)
    ...
    if ($c_name[$cno] =~ /天神|海神|黒神|炎神|地神/) {
      ...
      @god = $c_name[$cno] eq "G・A・ペガサス" ? ("1713")
         ...
         :$c_name[$cno] eq "イズモ" ? ("3968","3969","3978","3979","4007","4008","4009","4010","4026","4027","4048","4049" , "4302","4281","4127","4183","4304","4280","4128","4184","3968-3969","3968-3979","3968-4007","3968-4009","3968-4026","3968-4048","3968-4304","3968-4280","3968-4128")
