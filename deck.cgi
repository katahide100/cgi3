  ...
  print <<"EOM";
    ...
    <select name="series">
        ...
        <optgroup label = "十王篇">
            ...
            <option value="187" $selstr[187]>キングマスタースタートデッキ ゼーロJr.のムゲンクライム</option>
            <option value="178" $selstr[178]>第1弾 切札x鬼札 キングウォーズ!!!</option>
            <option value="183" $selstr[183]> 第2弾爆皇×爆誕 ダイナボルト!!</option>
            <option value="189" $selstr[189]>第3弾 幻龍×凶襲 ゲンムエンペラー!!!</option>
            <option value="192" $selstr[192]>第4弾 百王×邪王 鬼レヴォリューション!!!</option>
            ...
            <option value="190" $selstr[190]>四強集結→最強直結パック</option>
            <option value="184" $selstr[184]>最強戦略!!ドラリンパック</option>
            <option value="194" $selstr[194]>弩闘×十王 超ファイナルウォーズ!!!</option>
            <option value="185" $selstr[185]>クロニクル最終決戦デッキ 覚醒流星譚</option>
            <option value="186" $selstr[186]>クロニクル最終決戦デッキ ⿓魂紅蓮譚</option>
        <optgroup label = "王来篇">
            <option value="197" $selstr[197]>キングマスタースタートデッキ ジョーのスター進化</option>
            <option value="198" $selstr[198]>キングマスタースタートデッキ ジェンドルのディスペクター</option>
            <option value="206" $selstr[206]>キングマスタースタートデッキ ハイドのディスペクターN・EXT</option>
            <option value="199" $selstr[199]>第1弾 王星伝説超動</option>
            <option value="202" $selstr[202]>第2弾 禁時王の凶来</option>
            <option value="207" $selstr[207]>第3弾 禁断龍VS禁断竜</option>
            <option value="211" $selstr[211]>第4弾 終末王龍大戦</option>
            <option value="196" $selstr[196]>超獣王来烈伝</option>
        ...
        <optgroup label = "アビス・レボリューション">
            ...
            <option value="241" $selstr[241]>第4弾　竜皇神爆輝</option>
            <option value="236" $selstr[236]>大感謝祭 ビクトリーBEST</option>
            <option value="240" $selstr[240]>頂上決戦!!デュエキングMAX 2023</option>
            <option value="246" $selstr[246]>アビス・レボリューション外伝 「邪神と水晶の華」</option>
        <optgroup label = "王道篇">
            <option value="249" $selstr[249]>第1弾 「デーモン・オブ・ハイパームーン」</option>
            <option value="250" $selstr[250]>第2弾「カイザー・オブ・ハイパードラゴン」</option>
            <option value="254" $selstr[254]>第3弾「ゴールド・オブ・ハイパーエンジェル」</option>
            <option value="259" $selstr[259]>第4弾「悪魔神、復活」</option>
            <option value="251" $selstr[251]>超感謝祭 ファンタジーBEST</option>
            <option value="255" $selstr[255]>天下夢双!!デュエキングDreaM 2024</option>
            <option value="252" $selstr[252]>ドリーム英雄譚デッキ「ジョニーの書」</option>
            <option value="253" $selstr[253]>ドリーム英雄譚デッキ「ドギラゴンの書」</option>
            <option value="257" $selstr[257]>ドリーム英雄譚デッキ モモキングの書</option>
            <option value="258" $selstr[258]>ナイトメア黙示録デッキ バロムの章</option>
        <optgroup label = "王道W">
            ...
            <option value="275" $selstr[275]>エピソード4 パンドラ・ウォーズ</option>
            <option value="268" $selstr[268]>ドリーム英雄譚デッキ ボルシャックの書</option>
            <option value="269" $selstr[269]>ドリーム英雄譚デッキ アルカディアスの書</option>
            <option value="273" $selstr[273]>ドリーム英雄譚デッキ グレンモルトの書 </option>
        <optgroup label = "逆札篇">
            <option value="276" $selstr[276]>第1弾 逆転神VS切札竜</option>
            <option value="279" $selstr[279]>第2弾 燃えろ禁断！逆転のドギラゴン革命!! </option>
            <option value="278" $selstr[278]>ますますつよいパック 25の援軍</option>
            <option value="280" $selstr[280]>悪感謝祭 カリスマBEST</option>
            <option value="281" $selstr[281]>キャラプレミアムパック ドラゴン娘になりたくないっ！ 文化祭だョ！全員集合!!ドラ娘100％パック</option>
        ...
        <optgroup label = "エキサイティング・デュエパ・デッキ">
            <option value="242" $selstr[242]>ドラドラドラゴン龍幻郷</option>
            <option value="243" $selstr[243]>不敬なり！真邪眼騎士団</option>
            <option value="244" $selstr[244]>双極のアカシックZ計画</option>
            <option value="245" $selstr[245]>ネゴシエートの偽衒学者</option>
            <option value="260" $selstr[260]>アセビと異世界フェアリーたち</option>
            <option value="261" $selstr[261]>ツラトゥストラは水晶と語らう</option>
        <optgroup label = "キャラプレミムデッキ">
            <option value="247" $selstr[247]>「ドラゴン娘になりたくないっ！」 イェーイめっちゃドラゴン!!</option>
            <option value="256" $selstr[256]>「キャラプレミアムデッキ Duel Masters LOST 誓いの水晶」</option>
            <option value="265" $selstr[265]>「ドラゴン娘になりたくないっ！」 Jack‐Pot‐Live!! in桜龍高校</option>
            <option value="270" $selstr[270]>ドラゴン娘になりたくないっ！ はじけろスポーツ！青春☆ワールドカップ!!</option>
        ...
        <optgroup label = "にじさんじコラボ・マスターズ">
            <option value="262" $selstr[262]>「異次元の超獣使い」</option>
        ...
        <optgroup label = "特別なカード">
            ...
            <option value="166" $selstr[166]>プロモ限定カード第17期〜18期</option>
            ...
            <option value="223" $selstr[223]>プロモ限定カード第2１期（win編)</option>
            <option value="231" $selstr[231]>プロモ限定カード第22期  </option>
            <option value="248" $selstr[248]>プロモ限定カード第２３期</option>
            <option value="263" $selstr[263]> プロモ限定カード第２４期</option>
            <option value="277" $selstr[277]>プロモ限定カード第25期 </option>
