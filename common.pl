...
#		chmod 0000, "./tour/part.dat";
	...
	&error("超次元カードが9枚以上入っています。デッキを作り直してください。") if $#odeckp > 7;
	...
	if($winer == $tsno) {
		...
		# if($turn >= 13) {
			...
			my %deck_color = (
				...
				'lwz' => [$exist_color_t, $exist_color_t, 0, 0, 0, $exist_color_t],
				'wdz' => [0, $exist_color_t, $exist_color_t, 0, 0, $exist_color_t],
				'dfz' => [0, 0, $exist_color_t, $exist_color_t, 0, $exist_color_t],
				'fnz' => [0, 0, 0, $exist_color_t, $exist_color_t, $exist_color_t],
				'nlz' => [$exist_color_t, 0, 0, 0, $exist_color_t, $exist_color_t],
				'ldz' => [$exist_color_t, 0, $exist_color_t, 0, 0, $exist_color_t],
				'wfz' => [0, $exist_color_t, 0, $exist_color_t, 0, $exist_color_t],
				'dnz' => [0, 0, $exist_color_t, 0, $exist_color_t, $exist_color_t],
				'flz' => [$exist_color_t, 0, 0, $exist_color_t, 0, $exist_color_t],
				'nwz' => [0, $exist_color_t, 0, 0, $exist_color_t, $exist_color_t],
